        ...
        <div>
            ...
            <ul>
                @foreach($contacts as $contact)
                    <li class="ml-auto mr-auto mb-7 flex gap-10 w-5/6 justify-between items-center">
                        <input @checked(in_array($contact->id, old('contacts',[]) )) class="rounded" name="contacts[]"
                               type="checkbox"
